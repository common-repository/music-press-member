...
if(isset($_GET['id'])){
	...
	$music_press_member_cover_id = get_the_author_meta( 'music_press_member_cover', $user_id );
	$music_press_member_cover =  wp_get_attachment_url($music_press_member_cover_id);
	
	
	if(empty($music_press_member_cover)){
...
?>
	...
	<div class="cover">
        ...
        <?php
            ...
            echo '<div id="plupload-drag-drop'.$field_id.'" ><span id="plupload-browse-'.$field_id.'" class="clipart-upload button tooltip" title="'.__('Upload profile cover image.', 'music-press-member').'"><i class="fa fa-upload"></i></span></div>';
          ...
          $plupload_init = array(
           ...
           // 'container'           => 'plupload-'.$field_id.'',
            ...
            'multipart_params'    => array(
              ...
              'action'      => 'music_press_member_upload_cover_img',            // the ajax action name
            ),
          );
                 ...
                 <script>
                    ...
                    jQuery(document).ready(function($){
                      ...
                      uploader_'.$field_id.'.bind("FilesAdded", function(up, files){
						...
						$(".toast").html("'.__('Please wait.', 'music-press-member').'");
        ...
        <?php echo $music_press_member_cover; ?>
        </div>
