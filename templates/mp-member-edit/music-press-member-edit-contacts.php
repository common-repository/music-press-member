...
<div class="section contacts">
   <h2><?php echo __('Contacts', 'music-press-member'); ?></h2>
	...
	<?php echo $status_html; ?>
   		...
   		<form id="music-press-member-contacts" class="" action="#music-press-member-contacts" method="post">
       ...
       <?php
		...
		foreach($music_press_member_contacts as $index=>$work){
			...
			?>
            <div class="item">
                <span class="remove music-press-member-tooltip" title="<?php echo __('Delete', 'music-press-member'); ?>"><i class="fa fa-times"></i></span>
                <span class="move music-press-member-tooltip" title="<?php echo __('Sort', 'music-press-member'); ?>"><i class="fa fa-bars" aria-hidden="true"></i></span>
