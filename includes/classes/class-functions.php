...
class class_music_press_member_functions{
...
//							'html'=>apply_filters('music_press_member_filter_profile_navs_post', $this->music_press_member_filter_profile_navs_post($user_id)),
//							);
							
		$navs['about'] = array(
							'title'=>__('My Account', 'music-press-member'),
							'html'=>apply_filters('music_press_member_filter_profile_navs_about', $this->music_press_member_filter_profile_navs_about($user_id)),	
							);

		$navs['wishlist'] = array(
							'title'=>__('wishlist', 'music-press-member'),
							'html'=>apply_filters('music_press_member_filter_profile_navs_wishlist', $this->music_press_member_filter_profile_navs_wishlist($user_id)),
							);
							
		$navs['following'] = array(
							'title'=>__('Following', 'music-press-member'),
							'html'=>apply_filters('music_press_member_filter_profile_navs_following', $this->music_press_member_filter_profile_navs_following($user_id)),	
							);
		$navs = apply_filters('music_press_member_filter_profile_navs', $navs);		
	...
	function music_press_member_filter_profile_navs_post($user_id){
		ob_start();
	...
	function music_press_member_filter_profile_navs_about($user_id){
		ob_start();
		...
		<div class="basic-info">
        	<div class="container">
                ...
                <?php do_action('music_press_member_action_before_basic_info'); ?>
                ...
                <?php do_action('music_press_member_action_after_basic_info'); ?>
            ...
            <div class="container">
               ...
               <h5 class=""><?php echo __('Contacts', 'music-press-member'); ?></h5>
				...
				foreach($music_press_member_contacts as $contacts){
	...
	function music_press_member_filter_profile_navs_following($user_id)
    {
        ob_start();
        ...
        <div class="follower-list">
            ...
            if (!empty($follower_query)):
                foreach ($follower_query as $entry) {
                    ...
                    $music_press_member_cover_id = get_field('artist_banner', $artist_id);

                    if (empty($music_press_member_cover_id)) {

                        $music_press_member_cover = MUSIC_PRESS_MEMBER_PLUGIN_URL . 'assets/front/images/cover.png';
                        $music_press_member_cover = '<img src="' . $music_press_member_cover . '" />';
                    } else {
                        $music_press_member_cover = wp_get_attachment_url($music_press_member_cover_id);
                        $music_press_member_cover = '<img src="' . $music_press_member_cover . '" />';
                        //$music_press_member_cover = apply_filters('music_press_member_filter_profile_cover', $music_press_member_cover);
                    }
                    ...
                    <div class="single">
                    <div class="cover"><a
                                href="<?php echo $artist_url; ?>"><?php echo $music_press_member_cover; ?></a>
                    </div>
                    <div class="thumb"><a
                                href="<?php echo $artist_url; ?>"><?php  echo get_the_post_thumbnail( $artist_id, 'large'); ?></a>
                    </div>
	...
	function music_press_member_filter_profile_navs_wishlist($user_id){
        ob_start();
	...
	public function contact_methods() {
		...
		return apply_filters('music_press_member_contact_methods', $methods);
	...
	public function user_gender() {
		...
		return apply_filters('music_press_member_user_gender', $gender);
	...
	public function user_relationship() {
		...
		return apply_filters('music_press_member_user_relationship', $relations);
...
} new class_music_press_member_functions();